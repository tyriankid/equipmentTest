...
namespace DataAccess
{
    ...
    public class OleDbProvider : DataProvider
    {
        ...
        public override void Execute(String noneQuery)
        {
            ...
            OleDbHelper.Execute(this.ConnectionString, noneQuery, null, CommandType.Text);
        }
        ...
        public override Object GetScalar(String selectSql)
        {
            ...
            return OleDbHelper.ExecuteScalar(this.ConnectionString, selectSql, null, CommandType.Text);
        }
        ...
        {
            if (selectSql == null) throw new ArgumentNullException("selectSql");
            return OleDbHelper.ExecuteDataSet(this.ConnectionString, selectSql, null, CommandType.Text);
        }
        ...
        {
            if (selectSql == null) throw new ArgumentNullException("selectSql");
            return OleDbHelper.ExecuteReader(this.ConnectionString, selectSql, null, CommandType.Text);
        }
        ...
        public override void CommitDataTable(DataTable dataTable, String selectText)
        {
            ...
            OleDbHelper.UpdateDatatable(this.ConnectionString, selectText, dataTable.GetChanges());
        }
        ...
        public override void Execute(String noneQuery, DbParameter[] para)
        {
            ...
            OleDbParameter[] SqlPara = new OleDbParameter[para.Length];
            for (int i = 0; i < para.Length; i++)
            {
                SqlPara[i] = (OleDbParameter)para[i];
            }
            OleDbHelper.Execute(this.ConnectionString, noneQuery, SqlPara, CommandType.Text);
        }
        ...
        public override Object GetScalar(String selectSql, DbParameter[] para)
        {
            ...
            return OleDbHelper.ExecuteScalar(this.ConnectionString, selectSql, SqlPara, CommandType.Text);
        }
        ...
        public override DataSet GetDataset(String selectSql, DbParameter[] para)
        {
            ...
            return OleDbHelper.ExecuteDataSet(this.ConnectionString, selectSql, SqlPara, CommandType.Text);
        }
        ...
        public override IDataReader GetReader(String selectSql, DbParameter[] para)
        {
            ...
            return OleDbHelper.ExecuteReader(this.ConnectionString, selectSql, SqlPara, CommandType.Text);
        }
        ...
        public override void ExecuteTran(ArrayList sqlStringList)
        {
            ...
            OleDbHelper.ExecuteTran(this.ConnectionString, sqlStringList);
        }
        ...
        public override void CommitDataTableTran(DataTable dataTable, String selectText)
        {
            if (dataTable == null) throw new ArgumentNullException("dataTable");
            if (selectText == null) throw new ArgumentNullException("selectText");
            OleDbHelper.UpdateDataTableTran(this.ConnectionString, selectText, dataTable);
        }
        ...
        public override void ExecuteSp(String spName)
        {
            ...
            OleDbHelper.Execute(this.ConnectionString, spName, null, CommandType.StoredProcedure);
        }
        ...
        public override void ExecuteSp(String spName, DbParameter[] para)
        {
            ...
            OleDbHelper.Execute(this.ConnectionString, spName, SqlPara, CommandType.StoredProcedure);
        }
        ...
        {
            if (spName == null) throw new ArgumentNullException("spName");
            return OleDbHelper.ExecuteScalar(this.ConnectionString, spName, null, CommandType.StoredProcedure);
        }
        ...
        public override Object GetScalarBySp(String spName, DbParameter[] para)
        {
            ...
            return OleDbHelper.ExecuteScalar(this.ConnectionString, spName, SqlPara, CommandType.StoredProcedure);
        }
        ...
        {
            if (spName == null) throw new ArgumentNullException("spName");
            return OleDbHelper.ExecuteDataSet(this.ConnectionString, spName, null, CommandType.StoredProcedure);
        }
        ...
        public override DataSet GetDatasetBySp(String spName, DbParameter[] para)
        {
            ...
            return OleDbHelper.ExecuteDataSet(this.ConnectionString, spName, SqlPara, CommandType.StoredProcedure);
        }
        ...
        {
            if (spName == null) throw new ArgumentNullException("spName");
            return OleDbHelper.ExecuteReader(this.ConnectionString, spName, null, CommandType.StoredProcedure);
        }
        ...
        public override IDataReader GetReaderBySp(String spName, DbParameter[] para)
        {
            ...
            return OleDbHelper.ExecuteReader(this.ConnectionString, spName, SqlPara, CommandType.StoredProcedure);
        }
